...
- ⭐ THE ZELDA LOOK PASS — SHIPPED 2026-07-09 (Jon's go): cel ramp everywhere +
  inked outlines + character rim (stage 1), 6k wind-blown grass w/ scar awareness
  (stage 2), Player-1 body rebuild w/ jointed limbs (stage 3). Suite 57/57 ×3,
  whole pass costs ~1fps (46 vs 47 A/B). Plan + findings: `design/ZELDA-LOOK.md`,
  story: devlog 008. REMAINING from the plan: WW grayscale-mask water sparkle;
  bloom only if measured budget allows (research says it won't on iGPUs).
